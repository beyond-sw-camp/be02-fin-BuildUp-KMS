    ...
    public void findPassword(String email, String name) throws MessagingException {
        ...
        try {
            ...
            String content = "<html><body style= 'font-family: Pretendard; font-style: normal; font-weight: 500'> " +
                    ...
                    "<a href=`http://192.168.0.61` style='color: #fff; text-decoration: none; background-color: rgb(84, 29, 122); padding: 10px 20px; border-radius: 5px; border: 2px solid rgb(84, 29, 122); display: inline-block; font-size: 20px; line-height: 1;'>\n" +
                    "로그인 하기\n" + "</a>\n" + "</div>" + "</body></html>";
