...
const routes = [
  ...
  { path: "/admin/board/category/register", component: AdminBoardCategoryRegisterPage, },
  { path: "/admin/review/category/register", component: AdminReviewCategoryRegisterPage, },
  { path: "/admin/board/category/update", component: AdminBoardCategoryUpdatePage,  },
  { path: "/admin/review/category/update", component: AdminReviewCategoryUpdatePage, },
  { path: "/admin/tag/update", component: AdminTagUpdatePage,  },
