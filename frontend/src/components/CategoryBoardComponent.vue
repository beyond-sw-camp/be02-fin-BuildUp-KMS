    ...
    <div class="css-k59gj9">
      <div class="css-aw1sgr">
        ...
        <div class="css-kem115">
          ...
          <!--사진-->
          <img v-if="boards.boardImg" :src="boards.boardImg" class="css-17s6wd5" />
        </div>
        ...
        <div class="css-99cwur">
          ...
          <div class="css-1fhge30">
            ...
            <div class="css-5zcuov">
              <div class="css-1sika4i">{{ boards.nickName }}</div>
      ...
      <div class="css-k9ergi">
            ...
            <div class="css-hr47l6">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="#B4BFC6"></path>
                <rect x="4.58203" y="6.25" width="1.5" height="1.5" rx="0.75" fill="#B4BFC6"></rect>
                <rect x="7.25" y="6.25" width="1.5" height="1.5" rx="0.75" fill="#B4BFC6"></rect>
                <rect x="9.91797" y="6.25" width="1.5" height="1.5" rx="0.75" fill="#B4BFC6"></rect>
              </svg>
            </div>
        ...
        <div class="css-192oc4s">
          <div class="css-ts29it">
            <div class="css-hr47l6">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2" y="6.66565" width="1.33333" height="6" stroke="#B4BFC6" stroke-width="1.5"
