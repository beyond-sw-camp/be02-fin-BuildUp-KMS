            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h3 class="py-3 mb-4"><span class="text-muted fw-light">게시판 카테고리 /</span> 수정</h3>
...
export default {
    ...
    setup() {
        ...
        const updateCategory = async () => {
            ...
            try {
                await boardStore.updateBoardCategory(categoryIdx.value, newCategoryName.value);
                alert("게시판 카테고리 수정 완료!");
                router.push("/admin/board/category");
            } catch (error) {
                console.error("게시판 카테고리 수정 에러:", error);
                alert("게시판 카테고리 수정 실패");
            }
        };
