          ...
          <div class="css-axl4y">
            <div class="css-1yuvfju">
              ...
              <div class="css-agejl7">
                <div class="css-r8q25b">후기 작성</div>
                <div class="css-1iyoj2o">
                  <div class="css-1odc90o">
                    <div class="css-1t5srfe">
                      <button class="css-pfhqzm">
                        카테고리 선택<img src="@/assets/img/9042707_nav_arrow_down_icon.svg" class="css-1bhrqo4">
                      </button>
                    </div>
                    <div class="css-1yfg4fi">
                        <div class="css-1vitttd"></div>
                        <input placeholder="과정명을 입력해주세요." class="css-9y3tf9" value="">
                      </div>
                    <div class="css-1iqxhyo">
                      <textarea rows="1" placeholder="제목을 입력해주세요." class="css-16kqrm" style="overflow: hidden; resize: none"></textarea>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="css-1iyoj2o">
                    <div class="css-1odc90o">
                      <div class="css-1t5srfe">
                  <button class="css-pfhqzm">
                    별점을 선택해주세요.<img src="@/assets/img/9042707_nav_arrow_down_icon.svg" class="css-1bhrqo4">
                  </button>
                  <br>
                  ...
                  <div class="">
                    <div class="quill">
                      <div class="ql-container ql-snow"> 
                        <textarea class="ql-editor ql-blank" placeholder="내용을 입력하세요

 • 게시판 특성에 맞지 않는 내용(분란성 글 및 댓글) 작성시 별도의
 통보 없이 활동 정지, 글 이동 및 삭제될 수 있습니다."></textarea>
                  ...
                  <div id="toolbar" class="ql-toolbar ql-snow">
                    <span class="ql-formats"><button content="코드 블록" class="ql-code-block css-1qhzcav" type="button">
                        ...
                        </svg></button></span><span class="ql-formats"><button content="이미지 첨부" class="ql-image css-1qhzcav" type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        </svg></button></span><span class="ql-formats"><button content="파일 첨부" class="attachments css-1qhzcav">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path d="M5 9.478v3.02a5 5 0 0 0 5 5v0a5 5 0 0 0 5-5V5.833" stroke="#505254" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M11.667 7.5V5.833A3.333 3.333 0 0 0 8.333 2.5v0A3.333 3.333 0 0 0 5 5.833V12.5" stroke="#505254" stroke-width="1.75" stroke-linecap="round"></path>
                          <path d="M8.336 5.832v6.667c0 .92.746 1.666 1.667 1.666v0c.92 0 1.666-.746 1.666-1.666v-5" stroke="#505254" stroke-width="1.75" stroke-linecap="round"></path>
                        </svg></button></span>
                  </div>
                </div>
...
.ql-snow.ql-toolbar button, .ql-snow.ql-update-toolbar button {
    height: 30px;
    width: 30px;
    padding: 0 5px;
}
