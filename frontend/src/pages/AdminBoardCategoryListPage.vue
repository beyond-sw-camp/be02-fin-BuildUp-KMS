      ...
      <div class="layout-page">
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h3 class="py-3 mb-4">
              <span class="text-muted fw-light">게시판 카테고리 /</span> 목록
            </h3>
              ...
              <div class="table-responsive text-nowrap">
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr v-for="boardCategories in categoryStore.boardCategoryList" :key="boardCategories.boardCategoryIdx">
                    <AdminBoardCategoryListComponent :boardCategories="boardCategories"/>
                    </tr>
                  </tbody>
                </table>
              </div>
...
import AdminBoardCategoryListComponent from "@/components/AdminBoardCategoryListComponent.vue";
import AdminMenuComponent from "@/components/AdminMenuComponent.vue";
import { useAdminStore } from "/src/stores/useAdminStore";

export default {
  name: "AdminBoardCategoryListPage",
  components: {
    AdminMenuComponent,
    AdminBoardCategoryListComponent
  },
  computed: {
  ...
  mounted() {
    ...
    this.categoryStore.getBoardCategoryList();
  },
};
</script>
