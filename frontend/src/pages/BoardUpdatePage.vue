    ...
    <div class="css-1g39gls">
      ...
      <div class="css-1qjp6uf">
        ...
        <div class="css-agejl7">
          ...
          <p> {{ boardStore.boardDetail.boardCategoryName }} 게시글 작성하기</p>
          </div>
            ...
            <div class="css-1odc90o">
              ...
              <div class="css-1iqxhyo">
                ...
                <textarea
                  ...
                  :placeholder="boardStore.boardDetail.boardTitle"
                ></textarea>
              </div>
            </div>
          </div>
                ...
                <div class="ql-container ql-snow">
                  ...
                  {{ boardDetail.boardContent }}
                    ...
                    <textarea
                      ...
                      :placeholder="boardStore.boardDetail.boardContent"
                    ></textarea>
                    <div
                      class="ql-clipboard"
...
export default {
  ...
  mounted() {
     this.boardStore.findBoardDetailByUserIdx();
  },
  methods: {
    async updateBoard() {
